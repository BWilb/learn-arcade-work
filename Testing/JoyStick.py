...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        if joysticks:
            """If anything is returned, go ahead and created new attributes for new joysticks"""
    ...
    def update(self, delta_time):
        # Update the position according to the game controller, y's are reversed
        if self.joystick:
