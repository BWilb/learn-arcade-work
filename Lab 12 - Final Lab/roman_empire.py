...
def main():
    ...
    for i in range(len(countries)):
        print(countries[i].description)
    print("Welcome player. You will be playing as Julius Caesar. You have just got done from sacking towns in the "
          "heartland of the barbaric german tribes.\nEscape back to Naples Italy. If you go back to Rome, you may be safe "
          "for a couple of rounds, but Rome is barely defensible and you won't be safe there.\nYou must also gather new "
          "legions along the way, for yours have been destroyed in Germany.")

    while alive is not False:
        print(countries[current_country])
